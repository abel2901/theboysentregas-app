...
public class MessagesActivity extends AppCompatActivity {
    ...
    private class ContactItem extends Item<ViewHolder> {
        ...
        public void bind(@NonNull ViewHolder viewHolder, int position) {
            TextView username = viewHolder.itemView.findViewById(R.id.txt_message_username);
            TextView message = viewHolder.itemView.findViewById(R.id.textView2);
            ImageView imgPhoto = viewHolder.itemView.findViewById(R.id.image_message_user);
